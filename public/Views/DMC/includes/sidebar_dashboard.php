<div class="sidebar">
    ...
    <ul class="nav-links">
        <li>
            <a href="<?php echo HOST; ?>/DMC/" id="stats">
                <i class='bx bx-stats'></i>
                <span class="links_name">Home</span>
            </a>
        </li>
        <li>
            <a href="<?php echo HOST; ?>/DMC/Alerts" id="alerts">
                <i class='bx bx-send'></i>
                <span class="links_name">Alerts</span>
            </a>
        </li>
        <li>
            <a href="<?php echo HOST; ?>/DMC/IncidentReporting" id="incidents">
                <i class='bx bxs-report'></i>
                <span class="links_name">Incident Reporting</span>
            </a>
        </li>
        <li>
            <a href="<?php echo HOST; ?>/DMC/Compensation" id="compensations">
                <i class='bx bx-money'></i>
                <span class="links_name">Compensation</span>
            </a>
        </li>
        <li>
            <a href="<?php echo HOST; ?>/DMC/SafeHouse" id="safehouse">
