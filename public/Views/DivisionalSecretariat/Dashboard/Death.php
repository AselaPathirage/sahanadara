    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn_blue', function(e) {
                ...
                $.ajax({
                    type: "PUT",
                    url: "<?php echo API; ?>divseccompapprove",
                    data: json,
                    headers: {
                    ...
                    success: function(result) {
                        console.log(result);
                        var url = "<?php echo HOST; ?>/DivisionalSecretariat/Dashboard/Compensation";
        ...
        function getFinal() {
            output = $.parseJSON($.ajax({
                type: "GET",
                url: "<?php echo API; ?>divsecdeath/<?php echo end($array); ?>",
                dataType: "json",
                headers: {
                    'HTTP_APIKEY': '<?php echo $_SESSION['key'] ?>'
                },
            ...
            if (obj['disapproved'] == 'a' && obj['dmcapproved'] == 'p') {
                $('#mystatus2').hide();
                $('#dmcname').text("Pending");
                $('#dmcremarks').append("Pending");
                // $('#mystatus').hide();
            } else if (obj['disapproved'] == 'a' && (obj['dmcapproved'] == 'r' || obj['dmcapproved'] == 'a')) {
