...
function createInitialTokens(select) {
    ...
    //     options_selected
    // } = getOptions(select);
    // const wrapper = select.parentNode;console.log("dad");
    // console.log(wrapper);
...
function createToken(wrapper, value, gnId) {
    const search = wrapper.querySelector(".search-container");
    // Create token wrapper
    const token = document.createElement("div");
    token.classList.add("selected-wrapper");
    const token_span = document.createElement("span");
    token_span.setAttribute("data-gnId", gnId);
...
function selectOption(e) {
    ...
    const gnId = option.getAttribute('data-gnId');;
    option.setAttribute("selected", "");//console.log(gnId);
    createToken(wrapper, e.target.dataset.value, gnId);
    if (input_search.value) {
        input_search.value = "";
    }
