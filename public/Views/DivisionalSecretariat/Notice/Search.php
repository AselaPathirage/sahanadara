                    ...
                    <thead>
                        <tr class="filters">
                            ...
                            <th style="width: 15%;text-align: center;">
                                <a href="<?php echo HOST; ?>/InventoryManager/Notice/viewNotice" class="btn_active">View</a>
                            </th> 
                            <th style="width: 15%;text-align:center;">
                                <a href="<?php echo HOST; ?>/InventoryManager/Notice/editNotice" class="btn_remove">Edit</a>
                            </th>
                            <th style="width: 15%;text-align:center;">
