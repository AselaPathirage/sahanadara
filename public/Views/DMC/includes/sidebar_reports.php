<div class="sidebar">
    ...
    <ul class="nav-links">
        <li>
            <a href="/<?php echo baseUrl; ?>/DMC/Report/UserReport" id="user">
                <i class='bx bxs-report'></i>
                <span class="links_name">User Report</span>
            </a>
        </li>
        <li>
            <a href="/<?php echo baseUrl; ?>/DMC/Report/IncidentReport" id="incident">
                <i class='bx bxs-report'></i>
        ...
        <li>
            <a href="/<?php echo baseUrl; ?>/DMC/Report/SafeHouseReport" id="safehouse">
                <i class='bx bxs-report'></i>
