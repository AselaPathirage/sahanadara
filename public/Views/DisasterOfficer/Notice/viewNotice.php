                        ...
                        <div style="padding-left:15% ;">
                                    <div class="column" style="width:90%;float: none;padding-left:5%;padding-top:2px;">
                                            <table style="border: none !important;width:70%;">
                                                <tr>
                                                    <td>Title</td>
                                                    <td><input type="text" id="your_name" name="yourname" disabled='true' value="Emergency situation in Ullala"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Number of Families</td>
                                                    <td><input type="text" id="your_name" name="yourname"  style="width: 100%;" disabled='true' value="10"></td>
                                                </tr>
                                                <tr>
                                                    <td>Number of People</td>
                                                    <td><input type="text" id="your_name" name="yourname"  style="width: 100%;" disabled='true' value="55"></td>
                                                </tr>
                                                <tr>
                                                    <td>Location</td>
                                                    <td>
                                                    <input type="text" id="your_name" name="yourname"  style="width: 100%;" disabled='true' value="321/A">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Description</td>
                                                    <td><textarea id="notes" name="drivernotes" rows="8" cols="50" disabled='true'>We are waiting for your kind responses.</textarea></td>
                                                </tr>
                                                <tr>
