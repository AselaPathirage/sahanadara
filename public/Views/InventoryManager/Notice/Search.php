                    ...
                    <thead>
                        <tr class="filters">
                            ...
                            <th style="width: 15%;text-align: center;">
                                <a href="/<?php echo baseUrl; ?>/InventoryManager/Inventory/serviceRequestForm" class="create">View</a>
                            </th> 
                            <th style="width: 15%;text-align:center;">
                                <a href="/<?php echo baseUrl; ?>/InventoryManager/Inventory/viewRequest" class="view">Edit</a>
                            </th>
                            <th style="width: 15%;text-align:center;">
